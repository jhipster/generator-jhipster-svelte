	...
	lib: [
		{
			...
			templates: [
				...
				'page/binary-record.svelte',
				'page/page.svelte',
				'page/page-header.svelte',
				'page/form.svelte',
				'page/search-form.svelte',
				'page/record.svelte',
				'alert.svelte',
				'button.svelte',
				'checkbox-control.svelte',
				'icon.svelte',
				'input-control.svelte',
				'modal.svelte',
				'search-control.svelte',
